...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepsmok.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'y9IRGtnoAK58vpkHn0V8mv1hsvJaDFPu4dIKOeewwP4',
        yandex: '42e0f16fbd20e048',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "logo": "https://bokepsmok.pages.dev/favicon.ico",
        "url": "https://bokepsmok.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokepsmok.pages.dev"
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepsmok.pages.dev/?q={search_term}", 
